...
export class CentresInteretComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  evidenceItems: Evidence[] = [
    {
      ...
      description: 'Plusieurs abonnements à des newsletters techniques spécialisées ont été découverts, révélant un intérêt constant pour l\'actualité technologique et les tendances émergentes.',
      discovered: false,
    ...
    },
    {
      ...
      icon: 'bi-book',
      description: 'Une vaste collection de livres techniques et de développement personnel a été trouvée, démontrant un engagement dans l\'apprentissage continu et le perfectionnement de compétences diverses.',
      discovered: false,
    ...
    },
    {
      ...
      icon: 'bi-stopwatch',
      description: 'Des dossards et médailles de courses à pied ont été retrouvés, indiquant une pratique régulière de la course à pied et une participation à des événements sportifs.',
      discovered: false,
    ...
    },
    {
      ...
      icon: 'bi-knife',
      description: 'Un ensemble d\'ustensiles de cuisine de qualité professionnelle et des ingrédients rares ont été découverts, suggérant une passion pour la gastronomie et la cuisine expérimentale.',
      discovered: false,
    ...
    },
    {
      ...
      icon: 'bi-airplane',
      description: 'De nombreux souvenirs de différents pays et cultures ont été retrouvés, révélant un goût prononcé pour les voyages et la découverte de nouvelles cultures.',
      discovered: false,
    ...
    },
    {
      ...
      description: 'Un système audio sophistiqué et une collection éclectique de musique ont été identifiés, démontrant une passion pour l\'écoute musicale de qualité.',
      discovered: false,
    ...
    },
    {
      ...
      icon: 'bi-controller',
      description: 'Plusieurs consoles de jeux et une importante bibliothèque de jeux vidéo ont été retrouvées, révélant un intérêt pour le gaming et la culture vidéoludique.',
      discovered: false,
    ...
    },
    {
      ...
      icon: 'bi-tree',
      description: 'Du matériel de randonnée et de camping de qualité a été découvert, indiquant un attrait pour les activités de plein air et l\'exploration de la nature.',
      discovered: false,
  ...
  interests: Interest[] = [
    // Technologie & Innovation
    {
      ...
      icon: 'bi-code-slash',
      category: 'tech',
      description: 'Exploration de projets personnels de programmation, allant des applications web aux scripts d\'automatisation, en passant par des expérimentations avec des technologies émergentes.',
      since: '2015',
      frequency: 'Plusieurs heures par semaine',
      skillsRelated: ['Problem Solving', 'Architecture Logicielle', 'Créativité Technique'],
      highlight: 'A contribué à plusieurs projets open source et partage régulièrement des outils et solutions sur GitHub.',
    ...
    },
    {
      ...
      icon: 'bi-radar',
      category: 'tech',
      description: 'Suivi régulier des tendances, innovations et évolutions du monde technologique à travers des newsletters spécialisées, conférences en ligne et communautés professionnelles.',
      frequency: 'Quotidienne',
      skillsRelated: ['Analyse de tendances', 'Curiosité intellectuelle', 'Adaptabilité'],
      relatedImages: [
    ...
    // Culture & Apprentissage
    {
      ...
      category: 'culture',
      description: 'Lecteur avide combinant ouvrages techniques pour le développement professionnel et littérature de fiction (science-fiction, thrillers) pour le plaisir et l\'évasion.',
      frequency: 'Quotidienne',
      skillsRelated: ['Acquisition de connaissances', 'Pensée critique', 'Créativité'],
      relatedImages: [
        { caption: 'Bibliothèque personnelle' },
        { caption: 'Dernières lectures' }
      ],
      highlight: 'Participe activement à un club de lecture mensuel et maintient une liste de lecture constamment mise à jour.',
    ...
    },
    {
      ...
      icon: 'bi-mortarboard',
      category: 'culture',
      description: 'Engagement dans un processus d\'apprentissage permanent à travers des cours en ligne, webinaires, et certifications professionnelles dans divers domaines connexes à l\'informatique.',
      since: '2017',
      frequency: 'Plusieurs heures par semaine',
    ...
    // Activités de plein air
    {
      ...
      icon: 'bi-lightning',
      category: 'outdoor',
      description: 'Pratique régulière de la course à pied avec participation à plusieurs événements sportifs comme des semi-marathons et courses urbaines.',
      since: '2019',
      ...
      highlight: 'A établi un record personnel de 1h45 au semi-marathon et continue de s\'améliorer progressivement.',
    ...
    },
    {
      ...
      icon: 'bi-map',
      category: 'outdoor',
      description: 'Amateur de randonnées en montagne et d\'exploration de nouveaux sentiers, avec un intérêt particulier pour les paysages naturels préservés et la photographie de nature.',
      frequency: 'Mensuelle, intensifiée pendant les vacances',
      skillsRelated: ['Planification', 'Orientation', 'Appréciation de la nature'],
      relatedImages: [
    ...
    },
    {
      ...
      icon: 'bi-binoculars',
      category: 'outdoor',
      description: 'Intérêt pour l\'observation de la faune et la flore locales, avec une attention particulière à la biodiversité et aux écosystèmes naturels.',
      frequency: 'Régulière',
      skillsRelated: ['Patience', 'Attention aux détails', 'Conscience environnementale'],
      requiredEvidence: 'evidence-nature'
    },
    ...
    // Art de vivre
    {
      ...
      icon: 'bi-egg-fried',
      category: 'lifestyle',
      description: 'Passion pour la cuisine créative et l\'expérimentation culinaire, avec un intérêt particulier pour les techniques modernes et les fusions de cuisines internationales.',
      since: '2018',
      ...
      highlight: 'A participé à un atelier de cuisine avec un chef étoilé et continue d\'explorer de nouvelles techniques culinaires.',
    ...
    },
    {
      ...
      icon: 'bi-cup-straw',
      category: 'lifestyle',
      description: 'Exploration de nouvelles cuisines, restaurants et produits gastronomiques, avec un intérêt pour les accords mets et vins et les traditions culinaires régionales.',
      frequency: 'Bimensuelle',
      skillsRelated: ['Sens du goût développé', 'Ouverture culturelle', 'Connaissance des produits'],
      requiredEvidence: 'evidence-cooking'
    },
    {
      id: 'travel',
      ...
      icon: 'bi-globe',
      category: 'lifestyle',
      description: 'Passion pour la découverte de nouvelles cultures, traditions et gastronomies à travers des voyages ciblés sur l\'immersion culturelle plutôt que le tourisme de masse.',
      since: '2010',
      frequency: '2-3 voyages significatifs par an',
      skillsRelated: ['Adaptabilité culturelle', 'Communication interculturelle', 'Organisation'],
      relatedImages: [
        { caption: 'Marché local en Asie' },
        { caption: 'Architecture européenne' }
      ],
      highlight: 'A visité plus de 20 pays sur 4 continents, avec une préférence pour les expériences authentiques et les rencontres locales.',
    ...
    // Divertissement
    {
      ...
      description: 'Passionné de musique avec des goûts éclectiques allant du rock alternatif à la musique électronique, avec une attention particulière à la qualité du son et aux performances live.',
      frequency: '5-10 concerts par an',
      skillsRelated: ['Appréciation artistique', 'Connaissance musicale', 'Ouverture culturelle'],
      relatedImages: [
    ...
    },
    {
      ...
      icon: 'bi-controller',
      category: 'entertainment',
      description: 'Amateur de jeux vidéo avec une préférence pour les titres à forte composante narrative ou stratégique, appréciant particulièrement les RPG, jeux d\'aventure et jeux indépendants innovants.',
      since: '2000',
      frequency: 'Quelques heures par semaine',
      skillsRelated: ['Résolution de problèmes', 'Pensée stratégique', 'Appréciation narrative'],
      highlight: 'Suit activement l\'évolution artistique et technologique du medium vidéoludique comme forme d\'expression culturelle.',
    ...
    },
    {
      ...
      icon: 'bi-camera',
      category: 'entertainment',
      description: 'Pratique de la photographie lors des voyages et randonnées, avec un focus sur les paysages, l\'architecture et la capture de moments culturels authentiques.',
      frequency: 'Lors des voyages et sorties',
      skillsRelated: ['Composition visuelle', 'Attention aux détails', 'Patience'],
      relatedImages: [
    ...
    },
    {
      ...
      icon: 'bi-trophy',
      category: 'entertainment',
      description: 'Intérêt pour les compétitions professionnelles de jeux vidéo, particulièrement dans les genres stratégiques et les jeux d\'équipe, avec suivi des tournois majeurs.',
      frequency: 'Hebdomadaire, intensifié pendant les grands tournois',
      skillsRelated: ['Analyse stratégique', 'Compréhension des dynamiques d\'équipe', 'Anticipation'],
      requiredEvidence: 'evidence-gaming'
    }
  ];
  ...
  loadSavedState(): void {
    ...
    if (responses.length > 0) {
      ...
      const evidenceResponse = responses.find(r => r.questionId === 'evidence_discovered');
      ...
      const photoFlippedResponse = responses.find(r => r.questionId === 'photo_flipped');
      if (photoFlippedResponse && typeof photoFlippedResponse.response === 'boolean') {
  ...
  saveState(): void {
    ...
    this.userDataService.saveResponse('centres', 'evidence_discovered', discoveredIds);
    
    // Sauvegarder la catégorie sélectionnée
    if (this.selectedCategory) {
      this.userDataService.saveResponse('centres', 'selected_category', this.selectedCategory);
    }
    
    // Sauvegarder l'état de la photo
    this.userDataService.saveResponse('centres', 'photo_flipped', this.isPhotoFlipped);
  ...
  checkModuleCompletion(): void {
    ...
    if ((allDiscovered || discoveredCount >= discoveryThreshold) && !this.isModuleCompleted) {
      this.completeModule();
    }
  }
...
Principaux centres d'intérêt: ${keyInterests} et autres.
  ...
  unlockInterests(interestIds: string[]): void {
    ...
    interestIds.forEach(id => {
      this.userDataService.saveResponse('centres', `interest_${id}_unlocked`, true);
    });
  }
  ...
  isCategoryUnlocked(categoryId: string): boolean {
    const category = this.interestCategories.find(cat => cat.id === categoryId);
    if (!category) return false;
    
    // Nombre d'indices découverts liés à cette catégorie
    const categoryInterests = this.interests.filter(interest => interest.category === categoryId);
    const unlockedInterests = categoryInterests.filter(interest => this.isInterestDiscovered(interest.id));
  ...
  isInterestDiscovered(interestId: string): boolean {
    ...
    const requiredEvidence = this.evidenceItems.find(ev => ev.id === interest.requiredEvidence);
  ...
  selectCategory(categoryId: string): void {
    ...
    this.userDataService.saveResponse('centres', 'selected_category', categoryId);
  }
  ...
  getSelectedCategoryName(): string {
    ...
    const category = this.interestCategories.find(cat => cat.id === this.selectedCategory);
  ...
  getInterestsByCategory(): Interest[] {
    ...
    return this.interests.filter(interest => interest.category === this.selectedCategory);
  }
