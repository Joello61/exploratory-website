...
export class CompetencesComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  skillCategories: SkillCategory[] = [
    ...
    { id: 'documentation', name: 'Documentation & Gestion', icon: 'bi-file-text' },
  ...
  skills: Skill[] = [
    ...
    },
    {
      ...
      category: 'frontend',
      level: 3,
      description: 'Création d\'applications web dynamiques avec Angular, en utilisant TypeScript et les composants réutilisables.',
      icon: 'bi-code-square',
    ...
    },
    {
      ...
      category: 'frontend',
      level: 3,
      description: 'Utilisation de TypeScript pour le développement frontend structuré et typé, permettant une meilleure maintenabilité du code.',
      icon: 'bi-braces',
    ...
    },
    {
      ...
      category: 'frontend',
      level: 3,
      description: 'Création d\'interfaces adaptatives pour différents appareils en utilisant les techniques modernes de CSS et les frameworks responsive.',
    ...
    // Backend
    {
      ...
      category: 'backend',
      level: 3,
      description: 'Développement de services backend robustes avec Spring Boot, incluant la création d\'API REST sécurisées.',
      icon: 'bi-gear',
    ...
    },
    {
      ...
      category: 'backend',
      level: 3,
      description: 'Conception d\'applications PHP structurées et performantes avec le framework Symfony.',
      icon: 'bi-code-slash',
    ...
    },
    {
      ...
      category: 'backend',
      level: 3,
      description: 'Création de serveurs et APIs avec Node.js et Express, pour des applications web modernes.',
      icon: 'bi-hdd-network',
    ...
    },
    {
      ...
      category: 'backend',
      level: 2,
      description: 'Utilisation de Python pour le développement backend avec Flask, l\'analyse de données et l\'automatisation.',
      icon: 'bi-filetype-py',
    ...
    },
    {
      ...
      category: 'mobile3d',
      level: 3,
      description: 'Intégration de technologies 3D dans des applications web, incluant l\'utilisation d\'API de traitement d\'images.',
      icon: 'bi-box',
      projects: ['Application d\'analyse de mesures corporelles 3D', 'Visualisation 3D web'],
      discovered: false
    },
    {
      id: 'api-integration',
      ...
      category: 'mobile3d',
      level: 3,
      description: 'Intégration d\'API externes et développement d\'API personnalisées pour les applications web et mobiles.',
      icon: 'bi-link',
    ...
    // DevOps & CI/CD
    {
      ...
      category: 'devops',
      level: 2,
      description: 'Conteneurisation d\'applications avec Docker pour faciliter le déploiement et assurer la cohérence des environnements.',
      icon: 'bi-box',
      projects: ['Environnements de développement', 'Configurations d\'applications'],
      discovered: false
    },
    {
      id: 'git',
      ...
      category: 'devops',
      level: 3,
      description: 'Gestion de versions et collaboration avec Git, incluant les workflows de branches et les stratégies de fusion.',
      icon: 'bi-git',
    ...
    // Bases de données
    {
      ...
      category: 'database',
      level: 3,
      description: 'Conception et gestion de bases de données PostgreSQL, incluant l\'optimisation de requêtes complexes.',
      icon: 'bi-database',
      projects: ['Bases de données d\'application', 'Stockage de données structurées'],
      discovered: false
    },
    {
      id: 'mysql',
      ...
      category: 'database',
      level: 3,
      description: 'Administration et optimisation de bases de données MySQL pour des applications web et mobiles.',
      icon: 'bi-database-fill',
      projects: ['Systèmes de stockage relationnels', 'Bases de données applicatives'],
      discovered: false
    },
    {
      id: 'sql-optimization',
      ...
      category: 'database',
      level: 2,
      description: 'Création et optimisation de requêtes SQL pour améliorer les performances des applications.',
    ...
    },
    {
      ...
      category: 'documentation',
      level: 2,
      description: 'Planification et suivi de projets techniques, coordination d\'équipe et gestion des délais.',
      icon: 'bi-kanban',
      projects: ['Gestion de projets chez SKOOVEL', 'Coordination d\'activités techniques'],
      discovered: false
    },
    {
      id: 'testing',
      ...
      category: 'documentation',
      level: 2,
      description: 'Mise en place et exécution de tests unitaires et fonctionnels pour assurer la qualité des applications.',
    ...
    // Soft Skills
    {
      ...
      category: 'softskills',
      level: 4,
      description: 'Collaboration efficace au sein d\'équipes de développement, partage de connaissances et adaptation aux environnements d\'équipe.',
      icon: 'bi-people-fill',
    ...
    },
    {
      ...
      category: 'softskills',
      level: 4,
      description: 'Capacité à s\'adapter rapidement à de nouvelles technologies, environnements et exigences de projet.',
      icon: 'bi-shuffle',
      projects: ['Alternance études-travail', 'Multiples environnements techniques'],
      discovered: false
    },
    {
      ...
      category: 'softskills',
      level: 3,
      description: 'Analyse approfondie des problèmes techniques et évaluation objective des solutions possibles.',
      icon: 'bi-lightbulb',
      projects: ['Résolution de problèmes complexes', 'Optimisation de solutions'],
      discovered: false
    },
    {
      id: 'time-management',
      ...
      category: 'softskills',
      level: 3,
      description: 'Organisation efficace du temps entre les responsabilités académiques et professionnelles dans le cadre de l\'alternance.',
      icon: 'bi-clock',
    ...
    },
    {
      ...
      category: 'softskills',
      level: 3,
      description: 'Approche créative dans la résolution de problèmes techniques et le développement de fonctionnalités innovantes.',
      icon: 'bi-palette',
